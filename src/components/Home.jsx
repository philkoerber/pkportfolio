  ...
  return (
    <div className="h-fit md:h-[90vh] w-screen md:w-[80%] md:px-10 font-urbanist relative mx-auto">
      ...
      <ParallaxDiv
        ...
        <p className="text-xl">
          After completing my bachelor's degree in organbuilding back in
          Germany, I set out to travel the world. Finally based in Tokyo, I
          decided in September 2022 to start learning how to code in my free
          time, with a focus on frontend. I'm excited to showcase my skills and
          projects through my React portfolio.
        </p>
      </ParallaxDiv>
    </div>
  );
